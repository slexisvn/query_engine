...
export function findCommonEquiJoinKeys(expr, leftMapping, rightMapping) {
  if (!expr) return null;
...
export function extractJoinKeys(condition, leftMapping, rightMapping) {
  if (!condition) {
