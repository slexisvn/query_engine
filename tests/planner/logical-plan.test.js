import {
  PlanNodeType, JoinType, PhysicalStrategy,
...
describe('setChildren immutability', () => {
  ...
  it('preserves all non-children properties', () => {
    const join = LogicalJoin(JoinType.LEFT, lit('cond'), LogicalScan('A', []), LogicalScan('B', []), PhysicalStrategy.MERGE);
    ...
    expect(updated.physicalStrategy).toBe(PhysicalStrategy.MERGE);
