...
import { PageCache } from '../../src/storage/page-cache.js';
...
describe('PageCache', () => {
  ...
  describe('write and read', () => {
    it('round-trips a chunk through disk serialization', async () => {
      const pool = new PageCache(10, new FilePageStore(tmpDir, columnAllocator));
  ...
  describe('LRU caching', () => {
    ...
    it('evicts LRU page when cache is full', async () => {
      const pool = new PageCache(2, new FilePageStore(tmpDir, columnAllocator));
